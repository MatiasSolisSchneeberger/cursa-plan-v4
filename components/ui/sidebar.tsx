...
function SidebarMenuSkeleton({
	...
	// Random width between 50 to 90% set after mount to prevent SSR hydration mismatch.
...
function SidebarMenuSub({className, ...props}: React.ComponentProps<"ul">) {
	return (
		<ul
			...
			className={cn(
				"ml-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l border-sidebar-border py-0.5 group-data-[collapsible=icon]:hidden",
				className,
			)}
			{...props}
		/>
